...
# https://github.com/lsst/obs_decam/blob/master/tests/testGetRaw.py
...
#        exp = self.butler.get("bias", visit = fitsvisit[1],
#                              filter=fitsfilter[1], date = fitsdate[1][:10])
...
#        exp = self.butler.get("flat", visit = fitsvisit[2],
#                              filter=fitsfilter[2], date = fitsdate[2][:10])
